...
const float MIN_BOXSIZE = pow(BOXSIZE, -5);
...
void drawFractal(float boxSize, float offsetX, float offsetY, float offsetZ) 
{
    ...
    drawFractal(boxSize/2, offsetX+boxSize*0.75, offsetY, offsetZ);
    drawFractal(boxSize/2, offsetX, offsetY+boxSize*0.75, offsetZ);
    drawFractal(boxSize/2, offsetX, offsetY, offsetZ+boxSize*0.75);
    drawFractal(boxSize/2, offsetX-boxSize*0.75, offsetY, offsetZ);
    drawFractal(boxSize/2, offsetX, offsetY-boxSize*0.75, offsetZ);
    drawFractal(boxSize/2, offsetX, offsetY, offsetZ-boxSize*0.75);
}
